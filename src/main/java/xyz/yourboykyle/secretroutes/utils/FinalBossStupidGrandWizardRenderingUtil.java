...
public class FinalBossStupidGrandWizardRenderingUtil {
    ...
    private static final RenderPipeline SEE_THROUGH_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.POSITION_COLOR_SNIPPET)
                    .withLocation(Identifier.of("secretroutes", "see_through_overlay"))
    ...
    public static void register() {
        WorldRenderEvents.END_MAIN.register(FinalBossStupidGrandWizardRenderingUtil::render);
    }
