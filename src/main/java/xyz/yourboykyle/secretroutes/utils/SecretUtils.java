    ...
    public static void renderingCallback(JsonObject currentSecretWaypoints, int index2) {
        ...
        if (SRMConfig.get().playerWaypointLine) {
            ...
            if (nextSecret != null) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addLineFromCursor(new RenderTypes.LineFromCursor(point, SRMConfig.get().lineColor, SRMConfig.get().width));
            }
        }
            ...
            for (JsonElement etherwarpLocationElement : etherwarpLocations) {
                ...
                if (!SRMConfig.get().wholeRoute && etherwarpLocations.get(0) == etherwarpLocationElement && SRMConfig.get().playerToEtherwarp) {
                    ...
                    if (player != null) {
                        ...
                        FinalBossStupidGrandWizardRenderingUtil.addLineFromCursor(new RenderTypes.LineFromCursor(point, new Color(0, 255, 255), SRMConfig.get().width));
                    }
                }
                etherwarpPositions.add(pos);
                if (SRMConfig.get().etherwarpFullBlock) {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().etherWarp, 1, 1, true));
                } else {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().etherWarp, 1, 1, true));
                }
            }
        }
        ...
        if (currentSecretWaypoints != null && currentSecretWaypoints.get("mines") != null && (!SRMConfig.get().wholeRoute || SRMConfig.get().allSteps || index2 == Main.currentRoom.currentSecretIndex) && SRMConfig.get().renderMines) {
            ...
            for (JsonElement mineLocationElement : mineLocations) {
                ...
                if (SRMConfig.get().mineFullBlock) {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().mine, 1, 1, true));
                } else {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().mine, 1, 1, true));
                }
            }
        }
        ...
        if (currentSecretWaypoints != null && currentSecretWaypoints.get("interacts") != null && (!SRMConfig.get().wholeRoute || SRMConfig.get().allSteps || index2 == Main.currentRoom.currentSecretIndex) && SRMConfig.get().renderInteracts) {
            ...
            for (JsonElement interactLocationElement : interactLocations) {
                ...
                if (SRMConfig.get().interactsFullBlock) {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().interacts, 1, 1, true));
                } else {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().interacts, 1, 1, true));
                }
            }
        }
        ...
        if (currentSecretWaypoints != null && currentSecretWaypoints.get("tnts") != null && (!SRMConfig.get().wholeRoute || SRMConfig.get().allSteps || index2 == Main.currentRoom.currentSecretIndex) && SRMConfig.get().renderSuperboom) {
            ...
            for (JsonElement tntLocationElement : tntLocations) {
                ...
                if (SRMConfig.get().superboomsFullBlock) {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().superbooms, 1, 1, true));
                } else {
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().superbooms, 1, 1, true));
                }
            }
        }
        ...
        if (currentSecretWaypoints != null && currentSecretWaypoints.get("locations") != null && SRMConfig.get().lineType == SRMConfig.LineType.LINES && (!SRMConfig.get().wholeRoute || SRMConfig.get().allSteps || index2 == Main.currentRoom.currentSecretIndex)) {
            ...
            if (SRMConfig.get().modEnabled) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addLinesFromPoints(linePoints, SRMConfig.get().lineColor, SRMConfig.get().width, true);
            }
        }
        ...
        if (currentSecretWaypoints != null && currentSecretWaypoints.get("enderpearls") != null && (!SRMConfig.get().wholeRoute || SRMConfig.get().allSteps || index2 == Main.currentRoom.currentSecretIndex) && SRMConfig.get().renderEnderpearls) {
            ...
            for (JsonElement pearlLocationElement : pearlLocations) {
                ...
                if (SRMConfig.get().enderpearlFullBlock) {
                    ...
                    FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().enderpearls, 1, 1, true));
                } else {
                    Vec3d position = new Vec3d(posX, posY, posZ);
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().enderpearls, 1, 1, true));
                }
                ...
                FinalBossStupidGrandWizardRenderingUtil.addLine(new RenderTypes.Line(start, end, SRMConfig.get().pearlLineColor, SRMConfig.get().pearlLineWidth, true));
                ...
                case "interact":
                    if (SRMConfig.get().renderSecretIteract) {
                        if (SRMConfig.get().secretsInteractFullBlock) {
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().secretsInteract, 1, 1, true));
                        } else {
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().secretsInteract, 1, 1, true));
                        }
                        if (SRMConfig.get().interactTextToggle) {
                            Text text = Text.literal(getColorCode(SRMConfig.get().interactWaypointColor) + "Interact");
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().interactTextSize));
                        }
                    }
                    break;
                case "item":
                    if (SRMConfig.get().renderSecretsItem) {
                        if (SRMConfig.get().secretsItemFullBlock) {
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().secretsItem, 1, 1, true));
                        } else {
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().secretsItem, 1, 1, true));
                        }

                        if (SRMConfig.get().itemTextToggle) {
                            Text text = Text.literal(getColorCode(SRMConfig.get().itemWaypointColor) + "Item");
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().itemTextSize));
                        }
                    }
                    break;
                case "bat":
                    if (SRMConfig.get().renderSecretBat) {
                        if (SRMConfig.get().secretsBatFullBlock) {
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().secretsBat, 1, 1, true));
                        } else {
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().secretsBat, 1, 1, true));
                        }
                        if (SRMConfig.get().batTextToggle) {
                            Text text = Text.literal(getColorCode(SRMConfig.get().batWaypointColor) + "Bat");
                            Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                            FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().batTextSize));
                        }
                    }
                    break;
            }
        ...
        if (SRMConfig.get().etherwarpsTextToggle) {
            ...
            for (BlockPos etherwarpPos : etherwarpPositions) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().etherwarpsTextSize));
            }
        }
        ...
        if (SRMConfig.get().minesTextToggle) {
            ...
            for (BlockPos minePos : minesPositions) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().minesTextSize));
            }
        }
        ...
        if (SRMConfig.get().interactsTextToggle) {
            ...
            for (BlockPos interactPos : interactsPositions) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().interactsTextSize));
            }
        }
        ...
        if (SRMConfig.get().superboomsTextToggle) {
            ...
            for (BlockPos superboomPos : superboomsPositions) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().superboomsTextSize));
            }
        }
        ...
        if (SRMConfig.get().enderpearlTextToggle) {
            ...
            for (Triple<Double, Double, Double> enderpearlPos : enderpearlPositons) {
                ...
                FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().enderpearlTextSize));
            }
        }
        ...
        if (waypoints != null && waypoints.get("locations") != null && waypoints.get("locations").getAsJsonArray().size() > 0 && waypoints.get("locations").getAsJsonArray().get(0) != null) {
            if (index2 == 0) {
                ...
                if (SRMConfig.get().startTextToggle) {
                    ...
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().startTextSize));
                }
            }
            if (index2 == Main.currentRoom.currentSecretRoute.getAsJsonArray().size() - 1) {
                ...
                if (SRMConfig.get().exitTextToggle && type.equals("exitroute")) {
                    ...
                    Vec3d position = new Vec3d(pos.getX(), pos.getY(), pos.getZ());
                    FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().exitTextSize));
                }
            }
        }
    }
        ...
        if (secrets != null) {
            for (JsonElement secret : secrets) {
                ...
                if (name.contains("Chest") || name.contains("Bat") || name.contains("Wither Essence") || name.contains("Lever") || name.contains("Item")) {
                    ...
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, color, 1f, 1f, true));
                }
            }
    ...
    public static void renderLever() {
        ...
        if (currentLeverPos != null || !levers.isEmpty()) {
            ...
            if (currentLeverPos == null) {
                ...
                if (SRMConfig.get().secretsInteractFullBlock) {
                    Vec3d position = new Vec3d(abs.getOne(), abs.getTwo(), abs.getThree());
                    FinalBossStupidGrandWizardRenderingUtil.addFilledBox(new RenderTypes.FilledBox(position, SRMConfig.get().secretsInteract, 1f, 1f, true));
                } else {
                    Vec3d position = new Vec3d(abs.getOne(), abs.getTwo(), abs.getThree());
                    FinalBossStupidGrandWizardRenderingUtil.addOutlinedBox(new RenderTypes.OutlinedBox(position, SRMConfig.get().secretsInteract, 1f, 1f, true));
                }
                ...
                Vec3d position = new Vec3d(abs.getOne(), abs.getTwo(), abs.getThree());
                FinalBossStupidGrandWizardRenderingUtil.addWorldText(new RenderTypes.WorldText(text, position, true, SRMConfig.get().interactsTextSize)); // Assuming interactsTextSize exists
